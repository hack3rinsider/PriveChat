package com.stardust.privechat.Adapters;
...
import com.stardust.privechat.Models.Message;
import com.stardust.privechat.Models.User;
import com.stardust.privechat.R;
import com.stardust.privechat.databinding.DeleteDialogBinding;
import com.stardust.privechat.databinding.ItemReceiveGroupBinding;
import com.stardust.privechat.databinding.ItemSentGroupBinding;
...
//        });
//
//        if (holder.getClass() == MessagesAdapter.SentViewHolder.class){
//            MessagesAdapter.SentViewHolder viewHolder = (MessagesAdapter.SentViewHolder)holder;
//            if(message.getMessage().equals("Photo")){
//                viewHolder.binding.image.setVisibility(View.VISIBLE);
//                viewHolder.binding.message.setVisibility(View.GONE);
...
//
//        }else{
//            GroupMessagesAdapter.ReceiverViewHolder viewHolder = (GroupMessagesAdapter.ReceiverViewHolder)holder;
//            if(message.getMessage().equals("Photo")){
//                viewHolder.binding.image.setVisibility(View.VISIBLE);
//                viewHolder.binding.message.setVisibility(View.GONE);
//                Glide.with(context).load(message.getImageUrl()).into(viewHolder.binding.image);
